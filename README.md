...
Простая нейросеть на PyTorch. Определяет в градациях серого какого цвета пиксель -> https://github.com/Difrat/NNGreyscale.git<br>
Данный проект был посвещенн асинхроному программированию и парсингу -> https://github.com/Difrat/Bot_news.git<br>
